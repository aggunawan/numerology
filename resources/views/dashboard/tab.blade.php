<ul class="flex flex-row" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
    <li class="w-1/2 lg:w-auto" role="presentation">
        <button
            class="{{ $tab == 'summary' ? 'active' : null }} flex flex-row py-2 px-4 text-sm font-medium text-center text-gray-500 rounded-t-lg hover:text-blue-600 hover:shadow-md hover:bg-white hover:rounded font-bold ml-auto"
            id="profile-tab"
