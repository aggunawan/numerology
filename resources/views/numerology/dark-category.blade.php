<div class="p-2 w-full sm:max-w-md md:max-w-full mx-auto bg-gray-800 rounded-lg border shadow-md text-white {{ ($year ?? 0 ) == $numerology->getYear() ? 'border-green-400 border-8' : null }}">
