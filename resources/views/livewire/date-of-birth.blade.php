<div class="relative bg-white rounded-lg shadow">
    ...
    <div class="grid grid-cols-2 items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
        ...
        <button
            type="button"
            {{ $this->recalculateable ? null : 'disabled' }}
            class="font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center {{ $this->recalculateable ? 'text-white bg-blue-700 hover:bg-blue-800' : 'text-gray-800 bg-gray-300' }}"
            wire:click="recalculate">
            {{ $this->recalculateable ? 'Recalculate' : 'Credit empty' }}
        </button>
    </div>
</div>
