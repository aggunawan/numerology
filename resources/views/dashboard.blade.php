<x-app-layout>
    ...
    <div class="container mx-auto">
        <div class="py-4">
            <div class="flex flex-column justify-center px-4 md:hidden">
            ...
            <div class="grid grid-cols-3 gap-4 justify-center">
                <div class="p-4 w-full bg-white rounded-lg border shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700">
